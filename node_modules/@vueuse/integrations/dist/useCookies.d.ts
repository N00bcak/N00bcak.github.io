import * as _$universal_cookie0 from "universal-cookie";
...
declare function createCookies(req?: IncomingMessage): (dependencies?: string[] | null, {
   ...
   */
  get: <T = any>(name: string, options?: _$universal_cookie0.CookieGetOptions | undefined) => T;
  /**
   * Reactive get all cookies
   */
  getAll: <T = any>(options?: _$universal_cookie0.CookieGetOptions | undefined) => T;
  set: (name: string, value: any, options?: _$universal_cookie0.CookieSetOptions | undefined) => void;
  remove: (name: string, options?: _$universal_cookie0.CookieSetOptions | undefined) => void;
  addChangeListener: (callback: _$universal_cookie0.CookieChangeListener) => void;
  removeChangeListener: (callback: _$universal_cookie0.CookieChangeListener) => void;
};
/**
