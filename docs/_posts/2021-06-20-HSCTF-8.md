...
![]({{ site.baseurl }}/assets/Images/HSCTF8/hopscotch/hopscotchboard_base.png)

For a board with $$m+1$$ squares total, we could just tack on another square at the back:

![]({{ site.baseurl }}/assets/Images/HSCTF8/hopscotch/hopscotchboard_1.png)

Similarly, for a board with $$m+2$$ squares total, we could just tack on another two squares at the back:

![]({{ site.baseurl }}/assets/Images/HSCTF8/hopscotch/hopscotchboard_2.png)
